...
////                .build();
        ...
        httpRequestRetryHandler = new HttpRequestRetryHandler() {
            public boolean retryRequest(IOException exception, int executionCount, HttpContext context) {
                if (executionCount >= 4) {// 如果已经重试了4次，就放弃
                    return false;
                }
    ...
    //创建httpClient
    private static CloseableHttpClient getHttpClient() throws NoSuchAlgorithmException, KeyManagementException, KeyStoreException {
        init();
    ...
    public static boolean requestForWriteFile(String url,String fileSavePath) {
        ...
        defaultRequestConfig = RequestConfig.custom()
                ...
                .setSocketTimeout(240000)          //读取数据超时时间（等待数据超时时间）
...
//                    System.out.println(context);
     ...
     */
    public static void fileUp(String url,String fileName){
